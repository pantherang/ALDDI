...
from SSIDDI.models import *

from torch_geometric.data import Batch
from sklearn import metrics

class Passive_SSIDDI_Trainer:
    ...
    def train(self, h_train, t_train, rels_train, labels_train, cur_idx):
        # model.py
        self.model = train_SSIDDI(h_train, t_train, rels_train, labels_train, num_rels=self.num_rels, train_batch_size=self.train_batch_size, train_num_epoch = self.train_num_epoch, device = self.device)
