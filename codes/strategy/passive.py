...
def passive(tri_train, tri_test, encoder, dataset, trainer, query_batch_size, num_iters, num_rels):
    ...
    for iter in range(num_iters):
        idx_this_iter = random_idx[0:min((iter+1) * query_batch_size, len(rels_train))]
