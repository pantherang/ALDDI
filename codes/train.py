...
def main():
    ...
    if strategy == 'passive':
        model = passive(tri_train, tri_test, encoder, dataset, trainer, query_batch_size, num_iters, num_rels)
    elif strategy == 'shannon': 
        model = shannon(tri_train, tri_test, encoder, dataset, trainer, query_batch_size, num_iters, num_rels)
    elif strategy == 'most_likely_positive': 
        model = most_likely_positive(tri_train, tri_test, encoder, dataset, trainer, query_batch_size, num_iters, num_rels)
    elif strategy == 'k_center_greedy': 
        model = k_center_greedy(tri_train, tri_test, encoder, dataset, trainer, query_batch_size, num_iters, num_rels)
    elif strategy == 'BASE': 
        model = BASE(tri_train, tri_test, encoder, dataset, trainer, query_batch_size, num_iters, num_rels)
    elif strategy == 'MDC': 
        model = MDC(tri_train, tri_test, encoder, dataset, trainer, query_batch_size, num_iters, num_rels)
